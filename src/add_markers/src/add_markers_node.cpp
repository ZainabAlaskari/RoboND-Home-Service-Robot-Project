...
float pickGoal_x = 4.151847;
float pickGoal_y = 3.846164;
float dropGoal_x = 3.962205;
float dropGoal_y = -0.502280;
float thresh = 0.30f;
bool pickup = false;
bool dropoff = false;
...
int main( int argc, char** argv )
{
  ...
  // Pickup setup
  marker.pose.position.x = 4.151847;
  marker.pose.position.y = 3.846164;
  marker.pose.position.z = 0.0;
  marker.pose.orientation.x = 0.0;
  marker.pose.orientation.y = 0.0;
  marker.pose.orientation.z = 0;
  marker.pose.orientation.w = 1.193750;
